// stride_iter.hpp -- iterate through an iterable-type of numbers, n samples at a time
...
class stride_iter
{
  public:
    ...
    typedef typename iterator_traits<Iter_T>::reference reference;
    typedef typename iterator_traits<Iter_T>::difference_type difference_type;
    typedef typename iterator_traits<Iter_T>::pointer pointer;
