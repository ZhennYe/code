...
class Geometry:
  ...
  def _plotShollGraph(self, distances):
    ...
    pyplot.title('Sholl Analysis', fontsize=40)
    pyplot.xlabel('Distance from soma', fontsize=40)
    pyplot.ylabel('Number of compartments', fontsize=40)
    ax = pyplot.gca()
    for tick in ax.xaxis.get_major_ticks():
      tick.label1.set_fontsize(36)
