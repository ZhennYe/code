...
class DiffEqFunctor
{
  ...
  private:
    ...
    void fillMagnus2ndOrder(const Eigen::MatrixXd & dMat,
                            const Eigen::MatrixXd & dVec, const double & dT);
    // compute augmented magnus matrix to solve time endpoint at 4th-order
    void fillMagnusHalf4thOrder(const Eigen::MatrixXd & dMat1, const Eigen::VectorXd & dVec1,
                            const Eigen::MatrixXd & dMat2, const Eigen::VectorXd & dVec2,
                            const Eigen::MatrixXd & dMat3, const Eigen::VectorXd & dVec3,
                            const double & dT);
    // compute augmented magnus matrix to solve time endpoint at 4th-order
    void fillMagnus4thOrder(const Eigen::MatrixXd & dMat1, const Eigen::VectorXd & dVec1,
                            const Eigen::MatrixXd & dMat2, const Eigen::VectorXd & dVec2,
                            const Eigen::MatrixXd & dMat3, const Eigen::VectorXd & dVec3,
                            const double & dT);
    // compute augmented magnus matrix to solve time endpoint at 6th-order
    void fillMagnusPhony6thOrder(const Eigen::MatrixXd & dMat1, const Eigen::VectorXd & dVec1,
                                 const Eigen::MatrixXd & dMat2, const Eigen::VectorXd & dVec2,
                                 const Eigen::MatrixXd & dMat3, const Eigen::VectorXd & dVec3,
                                 const double & dT);
    ...
    getTruncatedParameters(const double & normMagnus);
