%% Comparing Relative Errors Between Euler and ODE23 methods
% Comparison of the Euler and ODE23 methods of solving the ODE given by the
...
% ODE23 Solver
[to,vo] = ode23(@fallingBody1,[0,200],v0);
...
title('Comparing Relative Error Between Euler and ODE23 methods')
legend('Euler','ode23')
xlabel('t (s)')
