...
switch (funVal)
    ...
    case 1 % Global average
        ...
        [handles.data.cleanSeg, handles.data.meanSeg, handles.data.stimTime, handles.data.saturLength] = ...
            ...
            0, lZero, tZero, endThresh, maxLength);
...
sampRate = str2double(get(handles.samplingRate,'String'));
filtThresh = str2double(get(handles.filtThresh,'String'));
isBandpass = get(handles.checkBandpass, 'Value');
set(handles.cleanBox,'Enable','on');
handles.data.cleanData = ArtFilt(handles.data.cleanData, sampRate, ...
    filtThresh, isBandpass);
...
% hObject    handle to editStimMinLength (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of editStimMinLength as text
%        str2double(get(hObject,'String')) returns contents of editStimMinLength as a double
...
% hObject    handle to checkBandpass (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkBandpass
...
% hObject    handle to ExportStimTime (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to rawFiltBox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
ArtPlotData(handles);
...
function RawFiltThresh_Callback(hObject, eventdata, handles)
% hObject    handle to RawFiltThresh (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of RawFiltThresh as text
%        str2double(get(hObject,'String')) returns contents of RawFiltThresh as a double


% --- Executes during object creation, after setting all properties.
function RawFiltThresh_CreateFcn(hObject, eventdata, handles)
% hObject    handle to RawFiltThresh (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in RawBandpass.
function RawBandpass_Callback(hObject, eventdata, handles)
% hObject    handle to RawBandpass (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of RawBandpass


% --- Executes on button press in RawFilterButton.
function RawFilterButton_Callback(hObject, eventdata, handles)
% hObject    handle to RawFilterButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.rawFilterInd,'BackgroundColor',[1 0 0]);
...
% hObject    handle to tbrawSegMin (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of tbrawSegMin as text
%        str2double(get(hObject,'String')) returns contents of tbrawSegMin as a double
    ArtPlotSeg(handles)
...
% hObject    handle to tbrawSegMax (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of tbrawSegMax as text
%        str2double(get(hObject,'String')) returns contents of tbrawSegMax as a double
    ArtPlotSeg(handles)
...
% hObject    handle to parm6val (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of parm6val as text
%        str2double(get(hObject,'String')) returns contents of parm6val as a double
...
% hObject    handle to fileVarsPopup (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = get(hObject,'String') returns fileVarsPopup contents as cell array
%        contents{get(hObject,'Value')} returns selected item from fileVarsPopup
...
% hObject    handle to editStimOffset (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of editStimOffset as text
%        str2double(get(hObject,'String')) returns contents of editStimOffset as a double
...
% hObject    handle to generalHelp (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to changeType (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to practicalHelp (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
