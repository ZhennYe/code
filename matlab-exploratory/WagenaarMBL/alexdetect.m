%% alexdetect - detects spikes by chaining together 2 wagenaar
% functions: detect spike and select spike
% to be more intuitive; spk = alexdetect (dat, tms, fac,t0,tkill);

function spk = alexdetect (dat, tms, fac,t0,tkill);
