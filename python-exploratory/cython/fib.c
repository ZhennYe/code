...
static char __pyx_k_home_alex_code_python_explorato[] = "/home/alex/code/python-exploratory/cython/fib.pyx";
...
static char __pyx_doc_3fib_fib[] = " Print Fibonacci series up to n. ";
 ...
 */
    __pyx_t_2 = __pyx_v_b;
    __Pyx_INCREF(__pyx_t_2);
    __pyx_t_1 = PyNumber_Add(__pyx_v_b, __pyx_v_a); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
