...
%   RASTERPLOT(T,N,L) 
%   Plots the rasters of spiketimes (T in samples) 
%   for N trials, each of length L samples, 
%   Sampling rate = 1kHz. Spiketimes are hashed by the trial length.
% 
...
trialgap = 1.1;    % distance between trials
defaultfs = 20e3;  % default sampling rate
